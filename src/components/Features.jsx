    ...
    <section className="py-28 px-4 h-auto mx-auto justify-center">
        ...
        <div className="flex flex-col md:flex-row justify-center mt-16 gap-10 mx-auto">
              <div className="flex flex-col">
                  <div className="bg-[#E8FFE8] rounded-xl p-10">
                      ...
                      <p className="font-primary font-normal text-[15px] text-[#8D8A8A] leading-[24px] mt-4 max-w-[293px]">Record and categorize daily expenses, and log sources of income. </p>
                      <div className="py-4">
                          <img src={expense_tracking} className="mx-auto w-auto h-auto" alt="" />
                      </div>
                  </div>
              </div>
              <div className="flex flex-col ">
              <div className="bg-[#DFFFF4] rounded-xl p-10">
                      ...
                      <div className="py-10">
                        <img src={budgeting} className="mx-auto w-auto h-auto" alt="" />
                      </div>
                  </div>
              </div>
              <div className="flex flex-col">
              <div className="bg-[#E8FFE8] rounded-xl p-10">
                      ...
                      <div className="py-14">
                        <img src={credit_card} className="mx-auto w-auto h-auto" alt="" />
                      </div>
                  </div>
              </div>
        </div>
