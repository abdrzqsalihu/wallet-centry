...
function Footer() {
  ...
  <section className="mx-auto">
      <section className="bg-[#385334] py-6">
          <div className="flex flex-col md:flex-row px-5 md:px-48 gap-6 justify-between">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-6 px-5 md:px-48">
            <div className="flex">
