...
function GetStarted() {
  return (
    <section className="py-28 px-4 h-auto mx-auto justify-center">
        <div className="flex flex-col-reverse md:flex-row justify-center gap-32">
            <div className="flex flex-col">
                <div style={backgroundPattern} className="bg-[#F8F8F8] md:w-[517px] md:h-[474px] flex flex-col items-center justify-end rounded-lg pt-10">
                  <img src={holding_phone_mockup} className="w-[80%] md:w-[75%] h-auto ml-20" alt="" />
              </div>
            </div>

            <div className="flex flex-col">
              <h1 className="font-primary font-bold text-[#222] text-[32px] md:text-[40px] md:max-w-[443px] leading-normal">Improve Your Financial Performance</h1>
